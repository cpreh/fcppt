...
#ifndef FCPPT_MAYBE_MULTI_HPP_INCLUDED
#define FCPPT_MAYBE_MULTI_HPP_INCLUDED

#include <fcppt/forward_optional_get.hpp>
#include <fcppt/optional_impl.hpp>
#include <fcppt/detail/has_value_all.hpp>
...
A multi version of \ref fcppt::maybe. Unfortunately, the variadic template
