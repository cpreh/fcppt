...
#ifndef FCPPT_OPTIONS_MISSING_OPTION_ERROR_HPP_INCLUDED
#define FCPPT_OPTIONS_MISSING_OPTION_ERROR_HPP_INCLUDED

#include <fcppt/options/long_name.hpp>
#include <fcppt/options/missing_option_error_fwd.hpp> // IWYU pragma: keep
...
{
public:
  FCPPT_OPTIONS_DETAIL_SYMBOL missing_option_error(
  ...
  [[nodiscard]] FCPPT_OPTIONS_DETAIL_SYMBOL bool operator==(missing_option_error const &) const;
private:
