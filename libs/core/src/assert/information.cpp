...
fcppt::assert_::information::information(
    ...
    : file_(std::move(_file)),
      ...
      condition_(std::move(_condition)),
      message_(std::move(_message))
{
}

fcppt::assert_::file const &fcppt::assert_::information::file() const { return file_; }

fcppt::assert_::line fcppt::assert_::information::line() const { return line_; }

fcppt::assert_::function const &fcppt::assert_::information::function() const { return function_; }

fcppt::assert_::condition const &fcppt::assert_::information::condition() const
{
  return condition_;
}

fcppt::assert_::message const &fcppt::assert_::information::message() const { return message_; }
