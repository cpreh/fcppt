...
fcppt::random::variate<Generator, Distribution>::variate(
    generator_reference const _generator, Distribution const &_distribution)
    : generator_(_generator), distribution_(_distribution)
{
}

template <typename Generator, typename Distribution>
fcppt::random::variate<Generator, Distribution>::variate(
    generator_reference const _generator, param_type const &_param)
    : generator_(_generator), distribution_(_param)
{
}
