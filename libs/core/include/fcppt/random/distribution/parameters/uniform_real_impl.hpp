...
fcppt::random::distribution::parameters::uniform_real<FloatType>::uniform_real(
    min const _min, sup const _sup)
    : min_(_min), sup_(_sup)
{
}

template <typename FloatType>
typename fcppt::random::distribution::parameters::uniform_real<FloatType>::wrapped_param_type
fcppt::random::distribution::parameters::uniform_real<FloatType>::convert_from() const
{
  return wrapped_param_type(
      fcppt::random::distribution::base_value(min_.get()),
      fcppt::random::distribution::base_value(sup_.get()));
}

template <typename FloatType>
fcppt::random::distribution::parameters::uniform_real<FloatType>
fcppt::random::distribution::parameters::uniform_real<FloatType>::convert_to(
    distribution const &_dist)
{
  return uniform_real(
      min(fcppt::random::distribution::decorated_value(_dist.a())),
      sup(fcppt::random::distribution::decorated_value(_dist.b())));
}
