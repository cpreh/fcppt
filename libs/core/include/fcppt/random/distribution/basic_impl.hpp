...
template <typename Parameters>
fcppt::random::distribution::basic<Parameters>::param_type
...
fcppt::random::distribution::basic<Parameters>::result_type
...
template <typename Parameters>
fcppt::random::distribution::basic<Parameters>::wrapped_distribution const &
...
template <typename Parameters>
fcppt::random::distribution::basic<Parameters>::result_type
fcppt::random::distribution::basic<Parameters>::make_result(
    wrapped_distribution::result_type const _value)
{
  return fcppt::random::distribution::decorated_value<result_type>(_value);
}

template <typename Parameters>
bool fcppt::random::distribution::operator==(
    fcppt::random::distribution::basic<Parameters> const &_left,
    fcppt::random::distribution::basic<Parameters> const &_right)
{
  return _left.distribution() == _right.distribution();
}
...
std::basic_ostream<Ch, Traits> &fcppt::random::distribution::operator<<(
    std::basic_ostream<Ch, Traits> &_stream,
    fcppt::random::distribution::basic<Parameters> const &_dist)
{
  return _stream << _dist.distribution();
}

template <typename Ch, typename Traits, typename Parameters>
std::basic_istream<Ch, Traits> &fcppt::random::distribution::operator>>(
    std::basic_istream<Ch, Traits> &_stream, fcppt::random::distribution::basic<Parameters> &_dist)
{
  return _stream >> _dist.distribution_;
}
