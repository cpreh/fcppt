...
class pos_ref_iterator final : public fcppt::container::grid::detail::pos_ref_iterator_base<Grid>
{
  using base_type = fcppt::container::grid::detail::pos_ref_iterator_base<Grid>;

  using dim = fcppt::container::grid::dim_type<std::remove_cv_t<Grid>>;

  using pos = fcppt::container::grid::pos_type<std::remove_cv_t<Grid>>;

  using iterator = fcppt::container::to_iterator_type<Grid>;
...
public:
  ...
  [[nodiscard]] bool equal(pos_ref_iterator const &) const;
