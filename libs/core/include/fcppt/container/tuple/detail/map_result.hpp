...
{
  using type = std::tuple<decltype(std::declval<Function>()(
      fcppt::move_if<fcppt::container::tuple::move_element<Tuple, Indices>::value>(
          std::get<Indices>(std::declval<Tuple>()))))...>;
};
