...
fcppt::container::get_or_insert_result<Reference>::get_or_insert_result(
    Reference _reference, bool const _inserted)
    : reference_(_reference), inserted_{_inserted}
{
}
...
fcppt::container::get_or_insert_result<Reference>::get_or_insert_result(
    get_or_insert_result<Other> const &_other)
    : reference_(_other.element()), inserted_(_other.inserted())
{
}
