...
<ul>
<li><code>template<typename Type> struct constructor</code> with an inner typedef called <code>type</code>. This applies the monad constructor to \a Type.</li>
<li><code>template<typenameType> struct inner_type</code> with an inner typedef called <code>type</code>. This extracts the type passed to a monad constructor.</li>
