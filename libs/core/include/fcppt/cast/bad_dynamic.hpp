...
*/
class FCPPT_SYMBOL_CLASS bad_dynamic : public fcppt::exception
{
public:
  /**
  ...
  */
  FCPPT_DETAIL_SYMBOL
  bad_dynamic(std::type_index const &source, std::type_index const &dest);

  FCPPT_DETAIL_SYMBOL
  bad_dynamic(bad_dynamic const &);

  FCPPT_DETAIL_SYMBOL
  bad_dynamic(bad_dynamic &&) noexcept;

  FCPPT_DETAIL_SYMBOL
  bad_dynamic &operator=(bad_dynamic const &);

  FCPPT_DETAIL_SYMBOL
  bad_dynamic &operator=(bad_dynamic &&) noexcept;

  FCPPT_DETAIL_SYMBOL
  ~bad_dynamic() noexcept override;
