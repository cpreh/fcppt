...
inline fcppt::iterator::range<fcppt::container::to_iterator_type<Range>> adapt_range(Range &_range)
{
  return fcppt::iterator::range<fcppt::container::to_iterator_type<Range>>{
      fcppt::range::begin(_range), fcppt::range::end(_range)};
}
