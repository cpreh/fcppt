...
*/
template <typename Dim, fcppt::math::size_type Size>
struct has_dim;

template <typename T, fcppt::math::size_type N, typename S, fcppt::math::size_type Size>
struct has_dim<fcppt::math::dim::object<T, N, S>, Size> : fcppt::math::detail::dim_matches<Size, N>
{
};
