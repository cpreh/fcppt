...
#ifndef FCPPT_PARSE_ERROR_VARIANT_IMPL_HPP_INCLUDED
#define FCPPT_PARSE_ERROR_VARIANT_IMPL_HPP_INCLUDED

#include <fcppt/parse/alternative_error_impl.hpp> // IWYU pragma: keep
#include <fcppt/parse/basic_char_error_impl.hpp> // IWYU pragma: keep
#include <fcppt/parse/basic_char_set_error_impl.hpp> // IWYU pragma: keep
#include <fcppt/parse/basic_literal_error_impl.hpp> // IWYU pragma: keep
