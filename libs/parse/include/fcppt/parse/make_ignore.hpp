...
fcppt::parse::ignore<fcppt::type_traits::remove_cv_ref_t<Parser>> make_ignore(Parser &&_parser)
{
  return fcppt::parse::ignore<fcppt::type_traits::remove_cv_ref_t<Parser>>{
