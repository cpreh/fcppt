...
IF(
	...
	FCPPT_CHECK_GCC_LINKER_FLAG(
		"-Wl,--as-needed"
		FCPPT_HAVE_AS_NEEDED_LINKER_FLAG
	)

	FCPPT_CHECK_GCC_LINKER_FLAG(
		"-Wl,--no-undefined"
		FCPPT_HAVE_NO_UNDEFINED_LINKER_FLAG
	)

	FCPPT_CHECK_GCC_LINKER_FLAG(
		"-Wl,--no-copy-dt-needed-entries"
		FCPPT_HAVE_NO_COPY_DT_NEEDED_ENTRIES_LINKER_FLAG
	)
	...
	IF(FCPPT_HAVE_AS_NEEDED_LINKER_FLAG)
		SET(
	...
	IF(FCPPT_HAVE_NO_UNDEFINED_LINKER_FLAG)
		SET(
			CMAKE_SHARED_LINKER_FLAGS
	...
	IF(FCPPT_HAVE_NO_COPY_DT_NEEDED_ENTRIES_LINKER_FLAG)
		SET(
			CMAKE_SHARED_LINKER_FLAGS
