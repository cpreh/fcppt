...
#ifndef FCPPT_LOG_IMPL_FIND_LOCATION_HPP_INCLUDED
#define FCPPT_LOG_IMPL_FIND_LOCATION_HPP_INCLUDED
...
fcppt::log::detail::const_optional_context_tree_ref const
find_location(
