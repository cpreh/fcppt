...
try
{
  ...
  auto const options_parser{
      fcppt::options::make_optional(fcppt::options::option<git_directory, fcppt::string>{
  ...
  auto const clone_parser{fcppt::options::argument<clone_path, fcppt::string>(
  ...
  //![main]
  fcppt::either::match(
      fcppt::options::parse(commands, fcppt::args_from_second(argc, argv)),
