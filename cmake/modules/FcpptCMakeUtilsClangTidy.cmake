...
# This defaults to .* if FCPPT_UTILS_CLANG_TIDY_WHITELIST is not set. Set
# FCPPT_UTILS_CLANG_TIDY_WHITELIST to specify a list of libraries to include in
# clang-tidy's header filter. If this list is a_1, ..., a_m, where m >= 0, then
# FCPPT_UTILS_CLANG_TIDY_HEADER_FILTER is set to a_1|...|a_m/.*. Use
# FCPPT_UTILS_CLANG_TIDY_EXTRA_ARGS to specify additional arguments.

set(FCPPT_UTILS_CLANG_TIDY
    ""
...
if(NOT "${FCPPT_UTILS_CLANG_TIDY}" STREQUAL "")
  ...
  string(JOIN "," FCPPT_UTILS_CLANG_TIDY_CHECKS_ARG
         ${FCPPT_UTILS_CLANG_TIDY_CHECKS})

  if("${FCPPT_UTILS_CLANG_TIDY_HEADER_FILTER}" STREQUAL "")
    if("${FCPPT_UTILS_CLANG_TIDY_WHITELIST}" STREQUAL "")
      set(FCPPT_UTILS_CLANG_TIDY_HEADER_FILTER ".*")
    else()
      string(JOIN "|" FCPPT_UTILS_CLANG_TIDY_WHITELIST_ARGS
