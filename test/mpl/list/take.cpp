...
int main()
{
  ...
  static_assert(std::is_same_v<
                fcppt::mpl::list::take<list, fcppt::mpl::size_type<0U>>,
                fcppt::mpl::list::object<>>);

  static_assert(std::is_same_v<
                fcppt::mpl::list::take<list, fcppt::mpl::size_type<1U>>,
                fcppt::mpl::list::object<int>>);

  static_assert(std::is_same_v<
                fcppt::mpl::list::take<list, fcppt::mpl::size_type<2U>>,
                fcppt::mpl::list::object<int, bool>>);

  static_assert(std::is_same_v<
                fcppt::mpl::list::take<list, fcppt::mpl::size_type<3U>>,
