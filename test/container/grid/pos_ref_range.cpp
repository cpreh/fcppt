...
template class fcppt::container::grid::pos_ref_iterator<fcppt::container::grid::object<int, 2>>;

static_assert(std::input_iterator<
              fcppt::container::grid::pos_ref_iterator<fcppt::container::grid::object<int, 2>>>);
...
{
  using element_type = fcppt::container::grid::pos<std::size_t, 2>;

  using dim2_grid = fcppt::container::grid::object<element_type, 2>;

  using min = fcppt::container::grid::min_from_pos<dim2_grid::pos>;

  using sup = fcppt::container::grid::sup_from_pos<dim2_grid::pos>;

  using pos = dim2_grid::pos;
