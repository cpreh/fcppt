...
int main()
{
  using result = fcppt::metal::set::difference<
  ...
  static_assert(fcppt::not_(fcppt::metal::set::contains<result, int>::value), "Set contains int");
  ...
  static_assert(
      fcppt::not_(fcppt::metal::set::contains<
                  result,
                  long // NOLINT(google-runtime-int)
                  >::value),
      "Set contains long");
